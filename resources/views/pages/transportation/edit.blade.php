	...
	<div class="card-body">
		...
		<input type="hidden" name="id" value="{{$field->id}}">
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-6">
						<input type="text" name="kode" class="form-control {{ $errors->has('kode')?'is-invalid':'' }}" value="{{ Request::old('kode',$field->code) }}" require>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-2">
						<input type="number" name="kapasitas" class="form-control {{ $errors->has('kapasitas')?'is-invalid':'' }}" value="{{ Request::old('kapasitas',$field->seat_qty) }}" require autofocus>

...
class ReservationControl extends Controller
{
    ...
    public function simpan(Request $req)
    {
    	$valid = Validator::make($req->all(),[
            ...
            'harga'=>'required|numeric|digits_between:2,50',
            'tanggal'=>'required|date_format:Y-m-d H:i:s',
            'tempat_duduk'=>'required|between:4,12|unique:reservation,seat_code,null,id,ruteid,'.$req->rute.',depart_at,'.$req->tanggal,
        ]);

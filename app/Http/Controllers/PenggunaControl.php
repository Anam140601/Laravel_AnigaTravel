...
class PenggunaControl extends Controller
{
    ...
    public function simpan(Request $req){
    	$valid = Validator::make($req->all(),[
    		'nama'=>'required|between:5,50',
    		'email'=>'required|between:15,50|email|unique:users,email',
            'username'=>'required|between:5,50|unique:users,username|alpha_dash',
    ...
    public function update(Request $req){
        ...
        $valid = Validator::make($req->all(),[
            'nama'=>'required|between:5,50',
            'email'=>'required|between:15,50|email|unique:users,email,'.$req->id,
            'username'=>'required|between:5,50|unique:users,username,'.$req->id.'|alpha_dash',
    ...
    public function settingUpdate(Request $req){
        ...
        $valid = Validator::make($req->all(),[
            'nama'=>'required|between:5,50',
            'email'=>'required|between:15,50|email|unique:users,email,'.Auth::user()->id,
            'username'=>'required|between:5,50|unique:users,username,'.$req->id.'|alpha_dash',
            'password'=>'nullable|min:6',
            'repassword'=>'nullable|same:password|required_with:password',
